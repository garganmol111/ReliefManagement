...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(afAuth, _fb, _snackBar, router, afDb) {
        this.afAuth = afAuth;
        this._fb = _fb;
    ...
    LoginComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeWhile"])(function () { return _this.isComponentActive; })).subscribe(function (res) {
            if (res)
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.afAuth.auth
            ...
            .then(function (res) {
            _this.afDb.object("users/" + res.user.uid).valueChanges().subscribe(function (res) {
                localStorage.setItem('userType', res.toString());
                _this.router.navigate(['']);
            });
        }, function (err) {
            _this._snackBar.open(err.message, 'Retry', { duration: 2000, verticalPosition: 'top' });
        });
    };
    LoginComponent.prototype.isEmailInvalid = function () {
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(_router, afAuth) {
        this._router = _router;
        this.afAuth = afAuth;
    }
    AuthGuard.prototype.canActivate = function () {
        var _this = this;
        return this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (user) {
            if (user)
                return true;
            else
                _this.defaultBehavior();
        }));
    };
    AuthGuard.prototype.defaultBehavior = function () {
